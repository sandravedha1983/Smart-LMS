...
from .views import (
    RegisterView, VerifyEmailView, SetupAdminView, ProfileDetailView, PendingProfessorsView, ApproveProfessorView,
...
urlpatterns = [
    ...
    path('auth/verify-email/<str:uid>/<str:token>/', VerifyEmailView.as_view(), name='verify-email'),
